...
# number of false negatives and positives (occluded but not predicted, and
# not occluded but predicted occluded)
...
# get error as mean squared error between actual distance at an angle
